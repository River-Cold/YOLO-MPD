...
target_layers = ['model_17_cv3_act', 'model_20_cv3_act']
...
parser.add_argument('--img-path', type=str, default='F:/code/dataset/kaist/visible', help='input image path')
...
def main(img_path):
    ...
    for target_layer in target_layers:
        ...
        # 保存设置
        image_name = os.path.basename(img_path)  # 获取图片名
