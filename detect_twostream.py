...
if __name__ == '__main__':
    ...
    parser.add_argument('--source1', type=str, default='F:/code/dataset/FLIR-align-3class/visible/test/', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='F:/code/dataset/FLIR-align-3class/infrared/test/', help='source')  # file/folder, 0 for webcam
