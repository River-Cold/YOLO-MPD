...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        # os.rename('F:/code/dataset/FLIR-align-3class/feature_save/fea_20x20.png', 'F:/code/dataset/FLIR-align-3class/feature_save/'+file_name+'_20x20'+'.png')
        # os.rename('F:/code/dataset/FLIR-align-3class/feature_save/fea_40x40.png', 'F:/code/dataset/FLIR-align-3class/feature_save/'+file_name+'_40x40'+'.png')
        # os.rename('F:/code/dataset/FLIR-align-3class/feature_save/fea_80x80.png', 'F:/code/dataset/FLIR-align-3class/feature_save/'+file_name+'_80x80'+'.png')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='F:/code/dataset/exp_save/multispectral-object-detection/5l_FLIR_3class_transformerx2_avgpool+maxpool/weights/best.pt', help='model.pt path(s)')
    ...
    p = "F:/code/dataset/FLIR-align-3class/labels/test"
