...
parser.add_argument('--model-path', type=str, default="F:/code/dataset/exp_save/multispectral-object-detection/5m_NiNfusion/weights/best.pt", help='Path to the model')
parser.add_argument('--source1', type=str, default='F:/code/dataset/kaist/visible/test', help='source')  # file/folder, 0 for webcam
parser.add_argument('--source2', type=str, default='F:/code/dataset/kaist/infrared/test', help='source')  # file/folder, 0 for webcam
parser.add_argument('--output-dir', type=str, default='F:/code/dataset/kaist/Grad_CAM_visual/outputs_nin_head', help='output dir')
...
if __name__ == '__main__':
    if os.path.isdir(args.source1):
        ...
        for item in img_vis_list[1127:]:
            ...
            if args.source1 == 'F:/code/dataset/FLIR-align-3class/visible/test':
