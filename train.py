...
from models.common import BiFPN_Concat2, BiFPN_Concat3, IAM
...
def train_rgb_ir(hyp, opt, device, tb_writer=None):
    ...
    for k, v in model.named_modules():
        ...
        # 向优化器中添加BiFPN的权重参数
            ...
            pg1.append(v.w)
        # 向优化器中添加IAM的权重参数
        elif isinstance(v, IAM) and hasattr(v, 'alpha') and isinstance(v.alpha, nn.Parameter):
            pg1.append(v.alpha)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./models/transformer/yolov5s_Add_kaist.yaml', help='model.yaml path')
    # parser.add_argument('--cfg', type=str, default='./models/transformer/yolov5l_Transfusion_FLIR.yaml', help='model.yaml path')
    # parser.add_argument('--cfg', type=str, default='./models/transformer/yolov5s_Transfusion_FLIR.yaml', help='model.yaml path')
    # parser.add_argument('--cfg', type=str, default='./models/ours/yolov8s_AddFusion.yaml', help='model.yaml path')
    # parser.add_argument('--cfg', type=str, default='./models/ours/yolov8s_AddFusion_IAM.yaml', help='model.yaml path')
    # parser.add_argument('--cfg', type=str, default='./models/ours/yolov8s_MaxFusion_CA-BiFPN.yaml', help='model.yaml path')
